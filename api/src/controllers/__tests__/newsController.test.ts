...
describe('News Controller', () => {
  ...
  beforeEach(() => {
    ...
    (NewsService.prototype.getTopHeadlines as jest.Mock).mockResolvedValue([]);
    (NewsService.prototype.searchNews as jest.Mock).mockResolvedValue([]);
  ...
  describe('GET /api/news/headlines', () => {
    it('should return top headlines', async () => {
      ...
      (NewsService.prototype.getTopHeadlines as jest.Mock).mockResolvedValue(mockArticles);
  ...
  describe('GET /api/news/search', () => {
    it('should search for news articles', async () => {
      ...
      (NewsService.prototype.searchNews as jest.Mock).mockResolvedValue(mockArticles);
