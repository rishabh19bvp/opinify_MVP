...
describe('News Article Model', () => {
    ...
    describe('Validation', () => {
        it('should validate a valid news article', async () => {
            const article = await NewsArticle_1.NewsArticle.create(testArticleData);
        ...
        it('should throw error for missing required fields', async () => {
            ...
            await expect(NewsArticle_1.NewsArticle.create(invalidArticle)).rejects.toThrow();
        });
        it('should validate URL uniqueness', async () => {
            ...
            const urlSchema = NewsArticle_1.NewsArticle.schema.path('url');
            expect(urlSchema).toBeDefined();
            // Check if the unique property is set to true
            const schemaOptions = urlSchema.options;
    ...
    describe('Tag Queries', () => {
        beforeEach(async () => {
            ...
            await NewsArticle_1.NewsArticle.create(testArticleData); // technology, test
        ...
        it('should find articles by tag', async () => {
            const articles = await NewsArticle_1.NewsArticle.findByTags(['technology']);
        ...
        it('should find articles by multiple tags', async () => {
            const articles = await NewsArticle_1.NewsArticle.findByTags(['health', 'science']);
            expect(articles.length).toBe(2);
